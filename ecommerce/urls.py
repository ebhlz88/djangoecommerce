...
urlpatterns = [
    ...
    path('add-to-cart/<int:pk>/<int:quantity>', views.add_to_cart_view,name='add-to-cart'),
    path('cart', views.cart_view,name='cart'),
    path('remove-from-cart/<int:pk>', views.remove_from_cart_view,name='remove-from-cart'),
    path('update-quantity-cart/<int:pk>/<int:quantity>', views.update_quantity_cart,name='update-quantity-cart'),
